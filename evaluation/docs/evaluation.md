...
**Question style diversity.** To avoid the dataset collapsing into a single question template (e.g., "What is the relationship between X and Y?"), we enforce diversity using the **NFQ taxonomy** (Kiesel et al., "Reproducible Web Corpora for Computational Argumentation Research", ACM SIGIR 2022). We use six of the seven NFQ styles:
